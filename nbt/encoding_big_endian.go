...
// WriteInt16 写入固定长度的 int16。
//
// WriteInt16 writes a fixed-width int16.
...
// WriteInt64 写入固定长度的 int64。
//
// WriteInt64 writes a fixed-width int64.
...
// WriteFloat32 写入固定长度的 float32。
//
// WriteFloat32 writes a fixed-width float32.
...
// WriteFloat64 写入固定长度的 float64。
//
// WriteFloat64 writes a fixed-width float64.
...
// WriteString 写入以 uint16 长度为前缀的字符串。
//
// WriteString writes a string prefixed with a uint16 length.
...
// Int16 读取固定长度的 int16。
//
// Int16 reads a fixed-width int16.
...
// Int32 读取固定长度的 int32。
//
// Int32 reads a fixed-width int32.
...
// Float32 读取固定长度的 float32。
//
// Float32 reads a fixed-width float32.
...
// String 读取以 uint16 长度为前缀的字符串。
//
// String reads a string prefixed with a uint16 length.
